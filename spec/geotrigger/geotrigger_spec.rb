...
describe ArcGIS::Geotrigger::AGO::Session do
  ...
  it 'fetches an access token for client credentials' do
    session_should_be_ok ArcGIS::Geotrigger::AGO::Session.new client_id: CONF[:client_id],
  ...
  it 'updates an expired access token with client credentials' do
    agos = ArcGIS::Geotrigger::AGO::Session.new client_id: CONF[:client_id],
                                                client_secret: CONF[:client_secret]
...
describe ArcGIS::Geotrigger::Session do

  it 'fetches an access token for client credentials' do
    s = ArcGIS::Geotrigger::Session.new client_id: CONF[:client_id],
                                        client_secret: CONF[:client_secret]
  ...
  it 'raises errors correctly' do
    s = ArcGIS::Geotrigger::Session.new
